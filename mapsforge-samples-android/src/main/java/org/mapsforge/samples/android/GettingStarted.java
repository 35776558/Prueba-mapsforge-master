...
public class GettingStarted extends Activity {
    ...
    private static final String MAP_FILE = "argentina.map";
//private static final File MAP_FILE= new File(Environment.getExternalStorageDirectory().getPath(),"argentina.map");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
             ...
             */
            mapView.setCenter(new LatLong(-24.7833, -65.4167));
